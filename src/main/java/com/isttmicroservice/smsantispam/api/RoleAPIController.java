...
import com.isttmicroservice.smsantispam.dto.RoleDTO;
import com.isttmicroservice.smsantispam.dto.SearchDTO;
import com.isttmicroservice.smsantispam.service.RoleService;
...
public class RoleAPIController {
  ...
  //  @PreAuthorize("hasRole('ROLE_ADMIN')")
   ...
   // @PreAuthorize("hasRole('ROLE_ADMIN')")
    ...
    @PutMapping("/user")
    // @PreAuthorize("hasRole('ROLE_ADMIN')")
     public ResponseDTO<Void> updateByUser(@RequestBody @Valid RoleDTO RoleDTO) throws IOException {
         roleService.updateByUser(RoleDTO);
         return ResponseDTO.<Void>builder().code(String.valueOf(HttpStatus.OK.value())).build();
     }
